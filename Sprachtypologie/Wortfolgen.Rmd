...
Außerdem sind die Nominalphrasen von Sätzen 3, 4 und 5 als Direktobjekt im Satz, aber im Satz 9 und 10 sind die Nominalphrasen als Subjekt. Diese Ansicht wird auch bei der Analyse berücksichtigt. Außerdem sind die Nominalphrasen von Sätzen 3, 4 und 5 als Direktobjekt im Satz, aber im Satz 9 und 10 sind die Nominalphrasen als Subjekt. Durch die Analyse von den erhobenen Sprachen zeigt es keine Unterschieden von der Wortstellung in Nominalphrasen von diesen fünf Sätzen (sehen Sie Daten von "Umfrage Analyse.xlsx").
